...
function loadModel(modelId, modelTexturesId){
	...
	loadlive2d('live2d', 'http://172.168.169.35:8088/live2d/get/'+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
		...
		url: 'http://172.168.169.35:8088/live2d/'+modelTexturesRandMode+'_textures/'+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
...
function loadOtherModel(){
    ...
    $.ajax({
		...
		url: 'http://172.168.169.35:8088/live2d/'+modelTexturesRandMode+'/'+modelId,
        dataType: "json",
        success: function (result){
